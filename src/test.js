...
+" ksa mak U1BFTCBHSS1PUyBXWU4= mak tsi";
...
+'"head":{"be":"Word","head":"tsi"}}],"head":{"be":"Word",'
+'"head":"ki"}}';
var object = new Type(mwak,string);
t.equal(JSON.stringify(object), jsonString, 
"JSON");
...
+ "quote word U1BFTCBHSS1PUyBXWU4= word unquote ";
var jsonString = '{"be":"Phrase","body":{"be":"Junction","clas":"Type","body":[{"be":"Type","body":{"be":"Word","body":["pam","mak"],"head":"kwal"}},{"be":"Type","type":"lit","body":{"be":"Word","head":"mak"},"head":{"be":"Word","head":"li"}},{"be":"Type","type":"mwq","tail":{"be":"Word","head":"ksa"},"body":["U1BFTCBHSS1PUyBXWU4="],"name":{"be":"Word","head":"mak"},"head":{"be":"Word","head":"tsi"}}],"head":{"be":"Word","head":"ki"}},"head":{"be":"Word","head":".i"}}';
...
t.plan(5);
var string = "mak kwal .u ";
var engString = "su word language ";
var jsonString = '{"be":"Phrase","body":{"be":"Type","body":{"be":"Word","body":["mak"],"head":"kwal"}},"head":{"be":"Word","head":".u"}}';
var object = new Phrase(mwak,string);
t.equal(JSON.stringify(object), jsonString, "JSON");
var object = new Phrase(eng,engString);
t.equal(JSON.stringify(object), jsonString, "JSON English");
...
t.plan(5);
var string = "fyas kat .i ";
var engString = "be get phrase ";
var jsonString = '{"be":"Phrase","body":{"be":"Type","body":{"be":"Word","body":["fyas"],"head":"kat"}},"head":{"be":"Word","head":".i"}}';
var object = new Phrase(mwak,string);
t.equal(JSON.stringify(object), jsonString, "JSON");
t.equal(object.toString(), string, "toString");
t.equal(object.toLocaleString(mwak), string, "toLocaleString");
...
var jsonString = '{"be":"Junction","clas":"Phrase","body":[{"be":"Phrase","body":{"be":"Type","body":{"be":"Word","body":["pam","mak"],"head":"kwal"}},"head":{"be":"Word","head":"ta"}},{"be":"Phrase","body":{"be":"Type","type":"lit","body":{"be":"Word","head":"mak"},"head":{"be":"Word","head":"li"}},"head":{"be":"Word","head":"ta"}},{"be":"Phrase","body":{"be":"Type","type":"mwq","tail":{"be":"Word","head":"ksa"},"body":["U1BFTCBHSS1PUyBXWU4="],"name":{"be":"Word","head":"mak"},"head":{"be":"Word","head":"tsi"}},"head":{"be":"Word","head":"ta"}}],"head":{"be":"Word","head":"ki"}}';
var object = new Type(mwak,string);
t.equal(JSON.stringify(object), jsonString, 
"JSON");
t.equal(object.toString(), string, 
...
var jsonString =
'{"be":"Phrase","clause":{"be":"Clause","body":{"be":"Sentence","phrases":[{"be":"Phrase","body":{"be":"Type","body":{"be":"Word","body":["pult"],"head":"tcan"}},"head":{"be":"Word","head":".a"}}]},"head":{"be":"Word","head":"kwa"}},"body":{"be":"Type","body":{"be":"Word","head":"mi"}},"head":{"be":"Word","head":".i"}}';
var object = new Phrase(mwak,string);
t.equal(JSON.stringify(object), jsonString, "JSON");
t.equal(object.toString(), string, "toString");
t.equal(object.toLocaleString(mwak), string, "toLocaleString");
...
var engString = "if su them ob live then joy be gentle with them ya";
var jsonString =
'{"be":"Sentence","phrases":[{"be":"TopClause","body":{"be":"Sentence","phrases":[{"be":"Phrase","body":{"be":"Type","body":{"be":"Word","head":"si"}},"head":{"be":"Word","head":".u"}},{"be":"Phrase","body":{"be":"Type","body":{"be":"Word","head":"lis"}},"head":{"be":"Word","head":".a"}}]},"head":{"be":"Word","head":"ku"}},{"be":"TopClause","body":{"be":"Sentence","phrases":[{"be":"Phrase","body":{"be":"Type","body":{"be":"Word","head":"si"}},"head":{"be":"Word","head":"mwa"}},{"be":"Phrase","body":{"be":"Type","body":{"be":"Word","head":"cwil"}},"head":{"be":"Word","head":".i"}}],"mood":{"be":"Word","head":"pac"}},"head":{"be":"Word","head":"twa"}}],"endWords":{"be":"Word","head":"ya"}}';
...
t.plan(4);
var string = "ksa fyas hello world fyas tsi .a yan .i ya";
var engString = "be say ob quote phrase hello world phrase"
+ " unquote ya";
var jsonString =
'{"be":"Sentence","phrases":[{"be":"Phrase","body":{"be":"Type","type":"mwq","tail":{"be":"Word","head":"ksa"},"body":["hello","world"],"name":{"be":"Word","head":"fyas"},"head":{"be":"Word","head":"tsi"}},"head":{"be":"Word","head":".a"}},{"be":"Phrase","body":{"be":"Type","body":{"be":"Word","head":"yan"}},"head":{"be":"Word","head":".i"}}],"endWords":{"be":"Word","head":"ya"}}';
var object = new Sentence(mwak,string);
t.equal(JSON.stringify(object), jsonString, "JSON");
t.equal(object.toString(), string, "toString");
t.equal(object.toLocaleString(mwak), string, "toLocaleString");
