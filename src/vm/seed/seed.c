...
void derive_first_word(const char* restrict sentence,
        const uint8_t length,
        char* restrict word,
        uint8_t* restrict fresh_length) {
...
void align_word(const char* restrict sentence, 
        const uint8_t length,
        uint32_t* restrict neat_sentence,
        uint8_t* restrict fresh_length) {
