...
/* new functions */
extern void deleteEmptyGlyph(const char *letter, const uint8_t
    length, char *neatLetter, uint8_t freshLength);
extern void encodeSpelWord(const char *word, const uint8_t
    length, uint16_t number);


/* old function */
extern void error(const char *news);
