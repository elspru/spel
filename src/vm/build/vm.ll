...
@.str = private unnamed_addr constant [20 x i8] c" t cat ca clah kxih\00", align 1
...
define i32 @main() #0 {
  ...
  call void @delete_empty_glyph(i8* %5, i16 zeroext 17, i8* %6, i16* %DAT_GEN_length)
  ...
  %12 = getelementptr inbounds [5 x i8]* %DAT_word, i32 0, i32 0
  call void @derive_first_word(i8* %9, i8 zeroext %11, i8* %12, i8* %DAT_word_GEN_length)
  %13 = getelementptr inbounds [5 x i8]* %DAT_word, i32 0, i32 0
